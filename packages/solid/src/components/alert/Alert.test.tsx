...
describe('Alert Component', () => {
	...
	it('applies variant classes correctly', () => {
		render(() => (
			<>
				<Alert {...defaultProps} data-testid="info-alert" variant="info" />
				<Alert {...defaultProps} data-testid="success-alert" variant="success" />
				<Alert {...defaultProps} data-testid="warning-alert" variant="warning" />
				<Alert {...defaultProps} data-testid="error-alert" variant="error" />
			</>
		));
